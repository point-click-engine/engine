...
describe PointClickEngine::Scenes::ScaleZoneManager do
  describe "#get_scale_at_y" do
    ...
    it "interpolates scale within a zone" do
      ...
      # At midpoint
      manager.get_scale_at_y(300).should be_close(0.75, 0.0001)

      # At 25% point
      manager.get_scale_at_y(200).should be_close(0.625, 0.0001)

      # At 75% point
      manager.get_scale_at_y(400).should be_close(0.875, 0.0001)
    end
    ...
    it "handles multiple zones" do
      ...
      # In first zone
      manager.get_scale_at_y(100).should be_close(0.45, 0.0001) # Midpoint of 0.3-0.6
