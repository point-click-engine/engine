  ...
  describe WalkablePointFinder do
    ...
    describe "private #is_point_walkable?" do
      it "considers non-walkable regions as higher priority" do
        ...
        result = finder.find_nearest_walkable_point(point_in_both, regions, 30.0) # Increased radius to find walkable points
        ...
        # Point outside all regions - should find nearest walkable
        point_outside = RL::Vector2.new(150, 150)
        result = finder.find_nearest_walkable_point(point_outside, regions, 80.0) # Increased radius to reach walkable area
