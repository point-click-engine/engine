...
describe "Animation Controller Comprehensive Tests" do
  describe "animation controller initialization and basic operations" do
    it "initializes animation controller correctly" do
      ...
      # Check initial state
      animation_controller.animations.size.should be >= 1 # Has default animations
      animation_controller.current_animation.should eq("idle")
      animation_controller.current_direction.should eq(PointClickEngine::Characters::Direction8::South)

      # Check default animations exist
      animation_controller.animations.has_key?("idle").should be_true
      animation_controller.animations.has_key?("walk_south").should be_true
    end
    ...
    it "handles basic animation registration" do
      ...
      animation_controller.add_animation("jump", 64, 4, 0.1_f32, false, 5, true, true, "jump.wav")
      ...
      jump_anim.priority.should eq(5)
      jump_anim.sound_effect.should eq("jump.wav")
    end
    ...
    it "handles animation playback control" do
      ...
      # Add test animation
      animation_controller.add_animation("test_action", 100, 8, 0.1_f32, false, 3)

      # Test playback
      result = animation_controller.play_animation("test_action")
      result.should be_true
      animation_controller.current_animation.should eq("test_action")

      # Test playing non-existent animation
      result = animation_controller.play_animation("nonexistent")
  ...
  describe "animation states and priorities" do
    ...
    it "handles auto return to idle" do
      ...
      # Add animation that should return to idle
      animation_controller.add_animation("temp_action", 80, 4, 0.1_f32, false, 5, true, true)
      ...
      # Check animation data
      anim_data = animation_controller.current_animation_data
  ...
  describe "performance and stress testing" do
    ...
    it "handles rapid animation switching" do
      ...
      switch_count.times do |i|
        ...
        animation_controller.play_animation(animation_name, force: true)
      end
    ...
    it "manages memory efficiently during animation lifecycle" do
      ...
      50.times do |cycle|
        ...
        20.times do |i|
          ...
          animation_controller.add_idle_variation("idle_#{cycle}_#{i}", (i + 100) * 10, 4)
        end

        # Add directional animations
        animation_controller.add_directional_animation("memory_walk_#{cycle}", cycle * 1000, 6)
  ...
  describe "edge cases and error handling" do
    ...
    it "handles zero frame animations" do
      ...
      result = animation_controller.play_animation("zero_frames")
      result.should be_true
    ...
    it "handles extreme animation parameters" do
      ...
      animation_controller.add_animation("extreme_priority", 0, 4, 0.1_f32, true, 999999)

      # Should handle all extreme cases
      animation_controller.play_animation("extreme_frames").should be_true
      animation_controller.play_animation("tiny_speed").should be_true
      animation_controller.play_animation("huge_speed").should be_true
      animation_controller.play_animation("extreme_priority").should be_true
    end
