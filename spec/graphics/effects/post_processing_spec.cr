...
describe PointClickEngine::Graphics::Effects::PostProcessing do
  describe ".create" do
    ...
    it "creates distortion effects" do
      # Heat haze
    ...
    it "handles color parsing in effects" do
  ...
  describe "effect lifecycle" do
    it "can update effect properties" do
      heat = PointClickEngine::Graphics::Effects::PostProcessing.create("heat_haze",
        strength: 0.01f32)
    ...
    it "tracks progress for timed effects" do
