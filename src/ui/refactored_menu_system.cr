...
module PointClickEngine
  module UI
    # Refactored menu system using extracted components
    #
    # This refactored MenuSystem delegates responsibilities to specialized components:
