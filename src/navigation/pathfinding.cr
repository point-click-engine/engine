...
module PointClickEngine
  module Navigation
    ...
    class Pathfinding
      ...
      def self.for_point_and_click(grid : NavigationGrid) : Pathfinding
      ...
      def self.for_grid_based(grid : NavigationGrid) : Pathfinding
      ...
      def self.for_strategy(grid : NavigationGrid) : Pathfinding
      ...
      def to_s(io : IO) : Nil
        io << "Pathfinding(grid: #{@grid.width}x#{@grid.height}, optimization: #{@optimize_paths}, debug: #{@enable_debug})"
      end
    end
  end
end
