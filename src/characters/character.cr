...
module PointClickEngine
  module Characters
    ...
    abstract class Character < Core::GameObject
      ...
      @[YAML::Field(ignore: true)]
      property animation_controller : AnimationController = AnimationController.new

      @[YAML::Field(ignore: true)]
      property sprite_controller : SpriteController = SpriteController.new(RL::Vector2.new, RL::Vector2.new)

      @[YAML::Field(ignore: true)]
      property state_manager : CharacterStateManager = CharacterStateManager.new
